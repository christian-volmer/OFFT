...
/*
	Number of additions       : 168
	Number of multiplications : 40
*/

template<> StandardModuleComplexity const StandardModule<float, 11>::Complexity = { 168, 40 };
template<> StandardModuleComplexity const StandardModule<double, 11>::Complexity = { 168, 40 };
...
template<> void StandardModule<float, 11>::Compute(float *pReal, float *pImag, ptrdiff_t stride, float const *twiddles) const
{
	ComputeCore(pReal, pImag, stride, twiddles);
}

template<> void StandardModule<double, 11>::Compute(double *pReal, double *pImag, ptrdiff_t stride, double const *twiddles) const
{
	ComputeCore(pReal, pImag, stride, twiddles);
}
