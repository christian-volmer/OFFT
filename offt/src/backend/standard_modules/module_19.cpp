...
/*
	...
	Number of multiplications : 88
*/

template<> StandardModuleComplexity const StandardModule<float, 19>::Complexity = { 376, 88 };
template<> StandardModuleComplexity const StandardModule<double, 19>::Complexity = { 376, 88 };
...
template<> void StandardModule<float, 19>::Compute(float *pReal, float *pImag, ptrdiff_t stride, float const *twiddles) const
{
	ComputeCore(pReal, pImag, stride, twiddles);
}

template<> void StandardModule<double, 19>::Compute(double *pReal, double *pImag, ptrdiff_t stride, double const *twiddles) const
{
	ComputeCore(pReal, pImag, stride, twiddles);
}
