...
/*
	Number of additions       : 400
	Number of multiplications : 64
*/

template<> StandardModuleComplexity const StandardModule<float, 28>::Complexity = { 400, 64 };
template<> StandardModuleComplexity const StandardModule<double, 28>::Complexity = { 400, 64 };
...
template<> void StandardModule<float, 28>::Compute(float *pReal, float *pImag, ptrdiff_t stride, float const *twiddles) const
{
	ComputeCore(pReal, pImag, stride, twiddles);
}

template<> void StandardModule<double, 28>::Compute(double *pReal, double *pImag, ptrdiff_t stride, double const *twiddles) const
{
	ComputeCore(pReal, pImag, stride, twiddles);
}
